	...
	if ( !function_exists('cherry_get_layout_class') ) {
		function cherry_get_layout_class($layout) {
			switch ($layout) {
				...
				case 'content':
					$layout_class = apply_filters( "cherry_layout_content_column", "span9" );
					$layout_class .= ' '.of_get_option('blog_sidebar_pos');
					break;

				case 'sidebar':
					$layout_class = apply_filters( "cherry_layout_sidebar_column", "span3" );
					break;
