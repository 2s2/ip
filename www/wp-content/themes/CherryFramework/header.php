...
@font-face {
  ...
  src: url('<?php echo PARENT_URL; ?>/fonts/fontawesome-webfont.eot?v=4.3.0');
  src: url('<?php echo PARENT_URL; ?>/fonts/fontawesome-webfont.eot?#iefix&v=4.3.0') format('embedded-opentype'),
url('<?php echo PARENT_URL; ?>/fonts/fontawesome-webfont.woff2?v=4.3.0') format('woff2'),
url('<?php echo PARENT_URL; ?>/fonts/fontawesome-webfont.woff?v=4.3.0') format('woff'),
url('<?php echo PARENT_URL; ?>/fonts/fontawesome-webfont.ttf?v=4.3.0') format('truetype'),
url('<?php echo PARENT_URL; ?>/fonts/fontawesome-webfont.svg?v=4.3.0#fontawesomeregular') format('svg');
  font-weight: normal;
  font-style: normal;
}
</style>
	<link rel="stylesheet" type="text/css" media="all" href="<?php echo PARENT_URL; ?>/css/font-awesome.css" />
	<link rel="stylesheet" type="text/css" media="all" href="<?php echo PARENT_URL; ?>/css/facebox.css" />
	...
	<script src="<?php echo PARENT_URL; ?>/js/facebox.js"></script>
</head>
				...
				<div class="row">
					<div class="span12">
						<ul class="links clearfix">
							<?php wp_register() ?>
							<li id="wp-admin-bar-loginout"><?php wp_loginout( '/'); ?></li>
						</ul>
					</div>
				</div>
				<div class="clear"></div>
